...
- Name: tests\lead-creation.spec.js >> 5. Lead Creation - Navigation and Form State >> 5.2 Cancel Lead Creation
...
- generic [ref=e1]:
  ...
  - iframe [ref=e26]:
    - generic [active] [ref=f1e1]:
      ...
      - paragraph [ref=f1e3]: "Reference #18.9adc55b8.1775100810.51d4d1da"
      - paragraph [ref=f1e4]: https://errors.edgesuite.net/18.9adc55b8.1775100810.51d4d1da
  - generic: Login
  - iframe [ref=e27]:
