                          ...
                          - generic [ref=e564]:
                            - heading "Campaign History (0)" [level=2] [ref=e570]:
                              - link "Campaign History (0)" [ref=e571] [cursor=pointer]:
                                - /url: /lightning/r/Lead/00QdN00000DjNNbUAN/related/CampaignMembers/view
                          ...
                          - generic [ref=e597]:
                            ...
                            - heading "Licenses (0)" [level=2] [ref=e603]:
                              - link "Licenses (0)" [ref=e604] [cursor=pointer]:
                                - /url: /lightning/r/Lead/00QdN00000DjNNbUAN/related/sfLma__R00N30000001JvRAEA0__r/view
...
> 98  |     await page.waitForTimeout(2000); // Brief wait for page to settle after redirect
      |                ^ Error: page.waitForTimeout: Target page, context or browser has been closed
  99  |     
  100 |     const url = page.url();
  101 |     expect(url).toMatch(/Lightning|savepointId|\/Lead\//i);
  102 |     
  103 |     // Check if page is still valid before screenshot
  104 |     try {
  105 |       const screenText = await page.textContent('body');
  106 |       if (screenText && screenText.includes('Acme Corporation')) {
  107 |         // HEALED: Capture success screenshot with test case ID
  108 |         const successScreenshot = await page.screenshot({ fullPage: true });
  109 |         const screenshotPath = path.join(screenshotDir, '1.1-Create-Lead-Required-Fields-PASSED.png');
  110 |         fs.writeFileSync(screenshotPath, successScreenshot);
  111 |         
